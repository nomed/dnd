...
* **Razza:** Custom Lineage
* **Classe:** Chierico
* **Dominio:** Luce *(nota: in 5e 2024 la sottoclasse arriva al 3° livello)*
* **Livello:** 2
* **Background:** Accolito (Ordine dell’Alba Infrangibile)
* **Allineamento:** Neutrale Buono (Fanatico Solare)
* **Bonus Competenza:** +2
...
* **PF Totali:** 10 *(da aggiornare se tiri/medi HP al 2°)*
* **Dado Vita:** 2d8
...
* **Corazza di Scaglie:** 14
* **Destrezza:** +1
* **Scudo:** +2

**CA Totale: 17**

Con *Scudo della Fede*: 19
...
* 1d20 + 6
* 4d6 danni radianti
* Prossimo attacco contro il bersaglio ha vantaggio

## 🥈 Fiamma Sacra (Trucchetto)
...
* TS DES CD 14
* 3d6 fuoco (cono 4,5 m)

## 🗡 Arma da mischia – Mazza
...
* Origine: Marchiato da una presenza del Piano Fatato
* +1 Saggezza (già incluso)
* **Passo Velato** (1x per riposo lungo senza slot)
* **Maledizione (Hex)** (1x per riposo lungo senza slot)

Interpretazione narrativa:
Aurelios non è semplicemente un chierico del sole. Qualcosa nel Feywild lo ha osservato nel momento in cui bruciò il suo villaggio. Da allora, quando invoca la luce, a volte le ombre sembrano muoversi controvento.

Possibile sviluppo:

* Una presenza invisibile lo osserva nei momenti di dubbio.
* Sogna foreste dorate e cieli cremisi.
* La sua magia talvolta ha riflessi verdastri o iridescenti.

---

# 📖 Incantesimi (Lvl 2 — 5e 2024)
...
# ✨ Capacità di Classe (Lvl 2)

## Bagliore Protettivo

* Reazione
* Impone svantaggio a un attacco contro di te
* Usi: 4 per riposo lungo

## Channel Divinity — 2 usi

* **Divine Spark:** cura o danno rad/nec
* **Turn Undead**
* Recuperi **1 uso** a riposo breve, tutti a riposo lungo
...
* Corazza di Scaglie
* Scudo con simbolo solare
* Mazza con testa a forma di sole
* Balestra leggera + 20 quadrelli
* Simbolo sacro inciso in oro
* Kit da sacerdote
* Abiti eleganti con mantello cremisi
* Incenso e fiale di acqua benedetta

---

# 🎭 Background e Trauma

Durante una pestilenza, Aurelios diede fuoco al proprio villaggio per fermare il contagio. Crede fermamente che la luce non sia misericordia, ma giudizio.

Frase tipica:

> "La luce non perdona. La luce purifica."

Cosa si dice di lui:

> "Non è malvagio. È pericolosamente convinto."

---

# 🌿 Presenza Misteriosa

Aurelios avverte talvolta uno sguardo oltre il sole.
Non è la sua divinità.
Non è un demone.

È qualcosa di antico, silenzioso, curioso.
...
* **LIVELLO:** 1 → **2**
* **Sottoclasse (2024):** non ancora attiva (entra al 3°)
* **Slot 1° livello:** 2 → **3**
...
- **Frase:** "La luce giudica e brucia la menzogna."
...
- **Frase:** "Ascolta il rintocco: la tua fine è già scritta."
...
- **Frase:** "Cammina nella luce, o resta cieco."
...
- **Frase:** "Un segno basta a piegare i timidi."
...
- **Frase:** "Nessuna ombra nasconde i colpevoli."
...
- **Frase:** "Nessuna lama oltrepassa il mio giudizio."
